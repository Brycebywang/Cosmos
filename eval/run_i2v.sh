...
export PROMPT=eval/prompt_i2v.jsonl


python cosmos1/models/diffusion/inference/video2world.py --num_steps 35 \
    --height 704 --width 1280 --num_video_frames 121 --fps 16 \
    --video_save_folder eval/output_14B_disable_promptrefiner_i2v \
